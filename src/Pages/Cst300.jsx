    ...
    return(
        <>
            ...
            <div id="project">
                ...
                <iframe src="/Personal-Website-React-Vite/projects/cst300_ethics_paper.pdf" width="100%" height="600px">
                    This browser does not support PDFs. Please download the PDF instead:
                    <a href="/Personal-Website-React-Vite/projects/cst300_ethics_paper.pdf">Download PDF</a>
                </iframe>
            </div>
            <Footer/>
        </>
